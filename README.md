...
**Project**: scroll-o-matic-gizmo 

**URL**: https://run.gptengineer.app/projects/18fe84b7-0852-4639-bda7-bd0b45f8914c/improve
...
However, you can easily transfer the repository to your own GitHub account by navigating to your [GPT Engineer project](https://run.gptengineer.app/projects/18fe84b7-0852-4639-bda7-bd0b45f8914c/improve) and selecting Settings -> GitHub. 
...
Simply visit the GPT Engineer project at [GPT Engineer](https://run.gptengineer.app/projects/18fe84b7-0852-4639-bda7-bd0b45f8914c/improve) and start prompting.
...
```sh
git clone https://github.com/GPT-Engineer-App/scroll-o-matic-gizmo.git
cd scroll-o-matic-gizmo
npm i
...
Simply visit your project at [GPT Engineer](https://run.gptengineer.app/projects/18fe84b7-0852-4639-bda7-bd0b45f8914c/improve) and click on Share -> Publish.
